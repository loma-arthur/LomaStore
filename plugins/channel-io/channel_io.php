...
define( 'CHANNEL_IO_VERSION', '0.13' );
...
function channel_io_plugin_init() {
  ...
  if (is_user_logged_in()) {
    ...
    $chMemberHash = hash_hmac('sha256', $current_user->ID, pack("H*", sanitize_text_field(get_option('channel_io_secret_key'))));
    ...
    $channel_io_options = array(
      ...
      'channel_io_member_hash' => $chMemberHash,
